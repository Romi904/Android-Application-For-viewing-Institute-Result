...
public class mech_database extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "mechanical";
    public static final int DATABASE_VERSION = 1;
    public static final String TABLE_NAME = "mechanical_data";
    ...
    public mech_database(Context context) {
